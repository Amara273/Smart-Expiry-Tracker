...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.image = customtkinter.CTkImage(light_image=Image.open("SmartGroceryExpiryTreacker/Tracker.png"),
                                            dark_image=Image.open("SmartGroceryExpiryTreacker/Tracker.png"), size=(600, 400))
...
class Signup(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.image = customtkinter.CTkImage(light_image=Image.open("SmartGroceryExpiryTreacker/icon.png"),
                                dark_image=Image.open("SmartGroceryExpiryTreacker/icon.png"),
                                size=(270, 400)) 
...
class Signin(ctk.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        self.image = customtkinter.CTkImage( dark_image=Image.open("SmartGroceryExpiryTreacker/icon.png"),
                                    size=(270, 400))
